...
export function HeroSection() {
  ...
  return (
    <section className="relative flex flex-col overflow-x-clip">
      ...
      <div className="relative z-10 flex flex-col lg:min-h-[calc(100svh-4.5rem)]">
        <div className="mx-auto grid w-full max-w-7xl flex-1 items-center gap-6 px-4 pb-6 pt-[max(5.5rem,calc(env(safe-area-inset-top)+4.75rem))] sm:gap-7 sm:px-6 sm:pb-8 sm:pt-24 lg:grid-cols-[1.2fr_0.8fr] lg:gap-10 lg:px-8 lg:pb-6 lg:pt-24">
          ...
          >
            ...
            <p className="mt-4 max-w-2xl text-[0.95rem] leading-7 text-zinc-300 drop-shadow-[0_3px_16px_rgba(0,0,0,0.9)] sm:mt-6 sm:text-lg sm:leading-8">
              ...
              <span className="hidden sm:inline">
                Juego Todo transforms Filipino Martial Arts into a professional spectator sport with weaponized
                competition, verified athlete identity, official rules, media, commerce, seminars, and championship
          ...
          >
            <div className="mx-auto w-full max-w-[18rem] sm:w-[85%] sm:max-w-[27rem] lg:ml-auto lg:mr-0">
              <div className="featured-event-poster glass-panel card-3d relative overflow-hidden rounded-[1.25rem] border border-[#FF1010]/15 bg-[#0D0D0D]/75 p-2 backdrop-blur-md sm:rounded-[1.5rem] sm:p-3">
