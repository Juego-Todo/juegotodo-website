...
export function InteriorPage({ slug }: { slug: PageSlug }) {
  ...
  return (
      <main className={`overflow-hidden ${isPartnersPage || isLatayanologyPage || isShopPage ? "" : "px-4 pb-14 sm:px-6 sm:pb-20 lg:px-8"} ${isShopPage || isPartnersPage || isLatayanologyPage ? "pt-20 sm:pt-24" : "pt-24 sm:pt-28 lg:pt-32"} ${isLatayanologyPage ? "pb-14 sm:pb-20" : ""} ${isShopPage ? "pb-28 sm:pb-32" : ""}`}>
