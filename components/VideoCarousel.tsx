    ...
    <section className="relative overflow-hidden border-t border-white/[0.08] bg-[#050505] py-16 sm:py-20">
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-8 flex justify-center sm:mt-10">
          <Link
            className="inline-flex min-h-12 items-center justify-center rounded-full bg-[#FF1010] px-6 py-3.5 text-xs font-black uppercase tracking-[0.18em] text-white shadow-[0_0_40px_rgba(255,16,16,0.45)] transition hover:bg-[#ff2828] sm:text-sm"
            href="/media#clips"
          >
            See More
