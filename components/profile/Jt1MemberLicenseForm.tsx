...
export function Jt1MemberLicenseForm({
  user,
  userPhone,
  initialApplication,
  showConfirmationInitially,
}: Jt1MemberLicenseFormProps) {
  ...
  const previewIdentity = useMemo(
    () =>
      ({
        memberId: application?.idNumber ?? "JT-PREVIEW",
        ...
        verifications: [],
        recentActivity: [],
      }) satisfies Pick<ProfileIdentity, "memberId"> & ProfileIdentity,
  ...
  function validateStep4() {
    ...
    if (!form.backgroundAnswers.instructor?.trim()) return "Instructor is required.";
  ...
  function handleEditApplication() {
    ...
    setStepError(null);
    setError(null);
    router.replace("/register-for-license");
  }
    ...
    <main className="overflow-hidden px-4 pt-24 sm:px-6 sm:pt-28 lg:px-8 lg:pt-32">
      <section className="relative mx-auto max-w-3xl py-8 sm:py-10">
        <MotionSection>
          ...
          <div className="mt-5">
            <p className="text-[0.62rem] font-black uppercase tracking-[0.18em] text-[#FF1010]">JT1 Member License</p>
            <h1 className="font-display mt-2 text-3xl uppercase text-white sm:text-4xl">Member Application</h1>
          </div>
          ...
          <form className="glass-panel mt-6 rounded-[1.5rem] p-5 sm:p-6" onSubmit={handleSubmit}>
            ...
            <div className="py-4">
              {step === 1 ? (
                <FormGroup
                  columns={3}
                  description="Enter your legal name and personal details exactly as they should appear on your JTGC member card."
              ...
              {step === 2 ? (
                <FormGroup description="We will use these details for application updates and membership correspondence." title="Contact Information">
                  <Field
                    label="Email Address"
              ...
              {step === 3 ? (
                <FormGroup description="Provide your current residential address in the Philippines." title="Address">
                  <Field
                    label="Country"
              ...
              {step === 4 ? (
                <FormGroup description="Tell us about your team, instructor, and club affiliation." title="Organization">
                  ...
                  <Field
                    label="Instructor"
                    onChange={(value) => updateBackgroundField("instructor", value)}
                    required
                    value={form.backgroundAnswers.instructor ?? ""}
                  />
                  <Field
                    className="sm:col-span-2"
                    label="Club Name"
              ...
              {step === 6 ? (
                <div className="space-y-4">
                  <FormGroup description="Upload clear copies of your government ID, profile photo, and signature." title="Uploads">
                    <FileUploadField
                      accept="image/*,.pdf"
                      label="Government ID"
                  ...
                  <section className="rounded-2xl border border-white/8 bg-black/20 p-4 sm:p-5">
                    <div className="mb-4 border-b border-white/8 pb-3">
                      <h3 className="text-xs font-black uppercase tracking-[0.18em] text-white">Digital Member Card Preview</h3>
                      <p className="mt-1.5 text-xs leading-5 text-zinc-500">
                        Review how your official JTGC member card will appear once approved. Drag to rotate the card.
                      </p>
                    </div>
                    <LicenseCardApplicationPreview form={form} identity={previewIdentity} user={user} />
                  </section>
                </div>
              ) : null}
            </div>
