...
const adminPortalNav: PortalNavItem[] = [
  { id: "overview", label: "Dashboard", icon: LayoutDashboard },
  { id: "admin-members", label: "Member Directory", icon: Users, href: "/admin/members" },
  { id: "admin-licenses", label: "License Approvals", icon: FileBadge2, href: "/admin/license-approvals" },
...
const councilNav: PortalNavItem[] = [
  ...
  { id: "admin-licenses", label: "Approvals", icon: FileBadge2, href: "/admin/license-approvals" },
